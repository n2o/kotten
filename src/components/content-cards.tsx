  ...
  return (
    <Card {...props}>
      ...
      <CardBody>
        ...
        privat zu einem Verein zusammen. Lweck des Vereins war der{" "}
        <i>
          "Erwerb und die Erhaltung des Grundstücks Diederichskotten zum Zwecke
          der Bereitstellung des Gebäudes und des Grundstückes für Pfadfinder im
          Besonderen und für Jugendarbeit"
        </i>{" "}
    ...
    <Card {...props}>
      ...
      <CardBody>
        <Text>
          ...
          das "Projekt Schuppen") benötigt man Ideen, viele Leute, deren Zeit
          und natürlich auch ausreichend finanzielle Mittel. Wir können uns
          glücklich schätzen, dass wir mal mehr und mal weniger über all' diese
          Dinge verfügen: so konnten wir nicht nur durch den unermüdlichen
          Einsatz aller Mitglieder des Diederichskotten e.V., sondern auch
          aufgrund der vielen fleißigen Helfer des Deutschen Pfadfinderbundes in
          Remscheid viele kleine und auch große Projekte am Haus und Gelände
          umsetzen. Dabei waren und sind wir immer mall wieder auch auf die
          finanzielle und / oder materielle Hilfe von Freunden und Förderern
          angewiesen. Da wir jedoch auch wissen, dass es für diese immer
          schwieriger wird, uns ohne entsprechende Spendenbescheinigung zu
          ...
          und Erhaltung unseres Gruppenheims. Zurzeit hat der Förderverein 12
          Mitglieder.
        </Text>
      </CardBody>
    </Card>
